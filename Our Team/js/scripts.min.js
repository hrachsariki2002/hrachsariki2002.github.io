...
$(function(){$(".agency-carousel").owlCarousel({items:1,loop:!0,smartSpeed:700,autoHeight:!0,nav:!1,dots:!0}),$(".team-slide").owlCarousel({loop:!0,items:1,smartSpeed:700,nav:!0,navText:['<i class="fas fa-angle-left"></i>','<i class="fas fa-angle-right"></i>'],dots:!1}),$(".hamburger").click(function(){0==$(".mob_mnu").hasClass("active")?$("body").css("overflow","hidden"):$("body").css("overflow","unset").css("overflow-x","hidden"),$(this).toggleClass("is-active"),$(".mob_mnu").toggleClass("active")});$(".s_about").waypoint(function(){768<=$(window).width()&&($(".ablog-wrap").addClass("animated").addClass("fadeInLeft"),$(".cnt_wrap").addClass("animated").addClass("fadeInRight"))},{offset:"20%"}),$(".s_exp").waypoint(function(){768<=$(window).width()&&$(".exp-items").addClass("animated").addClass("flipInX")},{offset:"25%"}),$(".s_team").waypoint(function(){768<=$(window).width()&&$(".team-item").addClass("animated").addClass("flipInY")},{offset:"10%"}),$(".s_works").waypoint(function(){768<=$(window).width()&&$(".works").addClass("animated").addClass("slideInLeft")},{offset:"10%"}),$(".s_slide").waypoint(function(){768<=$(window).width()&&$(".s_slide p, .team-slide").addClass("animated").addClass("fadeIn")},{offset:"10%"}),$(".s_contacts").waypoint(function(){768<=$(window).width()&&($(".s_contacts .h2, .form-wrap").addClass("animated").addClass("slideInLeft"),$(".client-wrap").addClass("animated").addClass("slideInRight"))},{offset:"10%"});$(window).resize(function(){768<=$(this).width()&&($(".hamburger").removeClass("is-active"),$(".mob_mnu").removeClass("active"))})});