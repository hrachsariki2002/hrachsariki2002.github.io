...
$(function(){$(document).ready(function(){$(window).scrollTop(0),setTimeout(function(){$("body").css("overflow","hidden"),$(".preloader").css("opacity","0"),$("body").css("overflow","unset").css("overflow-x","hidden")},1e3)}),$(".client-item").equalHeights();$(".s_descr").waypoint(function(){768<=$(window).width()&&$(".cnt_descr").addClass("animated").addClass("fadeInLeft")},{offset:"10%"}),$(".s_features").waypoint(function(){768<=$(window).width()&&($(".features-item").addClass("animated").addClass("slideInUp"),$(".s_features .little_title, .s_features .title").addClass("animated").addClass("fadeIn"))},{offset:"15%"}),$(".s_responsive").waypoint(function(){768<=$(window).width()&&($(".mac").addClass("animated").addClass("fadeInLeft"),$(".cnt_responsive").addClass("animated").addClass("fadeInRight"))},{offset:"10%"}),$(".s_clients").waypoint(function(){768<=$(window).width()&&($(".client-item").addClass("animated").addClass("slideInDown"),$(".client-logo").addClass("animated").addClass("fadeIn"))},{offset:"15%"});$(".up").click(function(){$("html, body").animate({scrollTop:0},900)}),$(window).scroll(function(){250<=$(window).scrollTop()?$(".up").css("right","30px"):$(".up").css("right","-100px")})});